...
tic
[Pmesh, policy, cutoff]=Simu_policy_constrained_v2(param_init,alpha,sigma2,r);
toc
figure
...
Cost_sim = simulation_Cost_constrained_v2(Pmesh, policy, cutoff, cost_opt, scale, a, Q0, R, d, f,eta);
