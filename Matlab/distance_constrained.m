function distance=distance_constrained(Pmesh, policy, cutoff, cost, length_time, a, Q, R, d, f)
    ...
    distance = norm((Q_sim'-Q(d:f))./Q(d:f));
    %distance = norm((R(d:f)./Q_sim'-R(d:f)./Q(d:f))./(R(d:f)./Q(d:f)));
end