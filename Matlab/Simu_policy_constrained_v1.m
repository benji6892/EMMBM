...
% %Figure
% figure
% area(Pmesh(1:100),ones(1,100))
% hold on
% plot(Pmesh(1:100),Solution_mesh(end-25,1:100),'Linewidth',1.5)
% plot(Pmesh(1:100),Solution_mesh(end-10,1:100),'Linewidth',1.5)
% plot(Pmesh(1:100),Solution_mesh(end,1:100),'Linewidth',1.5)
% legend('No Investment Region','375 Iterations','390 Iterations','400 Iterations','Location','northwest')
